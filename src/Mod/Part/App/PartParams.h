...
// Auto generated code (C:\Development\3D\FreeCAD\repo\src\Tools\params_utils.py:82)
#include <Base/Parameter.h>


// Auto generated code (C:\Development\3D\FreeCAD\repo\src\Tools\params_utils.py:90)
namespace Part {
...
public:
    ...
    static const bool & defaultAutoAuxGrouping();
    static void removeAutoAuxGrouping();
    static void setAutoAuxGrouping(const bool &v);
    static const char *docAutoAuxGrouping();
    //@}
...
// Auto generated code (C:\Development\3D\FreeCAD\repo\src\Tools\params_utils.py:179)
}; // class PartParams
} // namespace Part
//[[[end]]]
